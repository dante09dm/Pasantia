		...
		<v-form ref="form" style="padding: 1rem;">
			<v-row>
				<v-col cols="12" md="4" class="my-column">
					...
					<InputCategoriasUdec @cambiaCategoria="setea('categoria', $event)" :disabled="disabled"
						:categoria="params.categoria" />
				</v-col>
				<v-col cols="12" md="2" class="my-column">
					<label for="">Monto:</label>
					<v-text-field outlined dense class="input-text-sencha" v-model="params.monto"
						onkeypress="return soloMontos(event)"></v-text-field>
				</v-col>
				<v-col cols="12" md="3" class="my-column">
					<label for="">Desde:</label>
					<InputFecha :fecha="params.desde" @cambiaFecha="setea('desde', $event)" />
				</v-col>
				<v-col cols="12" md="3" class="my-column">
					<label for="">Hasta:</label>
					<InputFecha :fecha="params.hasta" @cambiaFecha="setea('hasta', $event)" />
				</v-col>
			</v-row>
			...
			<v-row>
				<v-col cols="12" md="12">
					<Panel :refreshCategorias="refreshCategorias" @editarCategoria="editarCategoria($event)"
						titulo="Categorías" content="gridCategorias" />
				</v-col>
			</v-row>
		</v-form>
